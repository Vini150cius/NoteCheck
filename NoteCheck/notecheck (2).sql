...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/11/2024 às 03:25
...
-- Procedimentos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_historico_listar` (IN `dataRetirada` DATE)   BEGIN 
IF(dataRetirada IS NULL) THEN
...
--
ALTER TABLE `uso_notebook`
  MODIFY `id_uso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
